...
export function RecentUserItem({
  ...
  return (
    <div className='div-user-item'>
      <img className='custom-link img-user' src={`/user_profile/profile_${userImageKey < 10 ? "0" : ""}${userImageKey}.png` || "/user_profile/profile_01.png"} alt="이미지" onClick={() => navigate("/user/" + nanoid)}/>
